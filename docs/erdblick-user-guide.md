...
- [Setup Guide](erdblick-setup.md) – Download/build options, serving erdblick with `mapget`, `/static-config`, source-backed style editing, server-supplied `/config.erdblick` overrides, and browser prerequisites.
