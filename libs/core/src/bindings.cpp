...
EMSCRIPTEN_BINDINGS(erdblick)
{
    ...
    em::class_<DeckFeatureLayerVisualization>("DeckFeatureLayerVisualization")
        ...
        .function("pathPositions", &DeckFeatureLayerVisualization::pathPositions)
        .function("pathStartIndices", &DeckFeatureLayerVisualization::pathStartIndices)
        .function("pathColors", &DeckFeatureLayerVisualization::pathColors)
        .function("pathWidths", &DeckFeatureLayerVisualization::pathWidths)
        .function("pathFeatureStart", &DeckFeatureLayerVisualization::pathFeatureStart)
        .function("pathFeatureIds", &DeckFeatureLayerVisualization::pathFeatureIds)
        .function("pathDashArray", &DeckFeatureLayerVisualization::pathDashArray)
        .function("pathDashOffsets", &DeckFeatureLayerVisualization::pathDashOffsets)
