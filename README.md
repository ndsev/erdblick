...
| `attribute-filter`            | A [simfil](https://github.com/klebert-engineering/simfil) expression to evaluate against the attribute's field.                                                                                              | String                                                     | `attributeValue.speedLimitKmh > 100`               |
