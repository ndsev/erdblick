...
const completionsList = [
    ...
    {label: 'lod-thresholds', type: 'property'},
    ...
    {label: 'lod-range', type: 'property'},
    {label: 'min-lod-expression', type: 'property'},
    ...
    {label: 'color-scale', type: 'property'},
    {label: 'opacity', type: 'property'},
    {label: 'width', type: 'property'},
    {label: 'depth-test', type: 'property'},
    {label: 'surface-shading', type: 'property'},
    {label: 'polygon-height', type: 'property'},
    {label: 'polygon-height-expression', type: 'property'},
    {label: 'z-index', type: 'property'},
    {label: 'z-index-expression', type: 'property'},
    {label: 'z-index-group-expression', type: 'property'},
    {label: 'z-index-role', type: 'property'},
    {label: 'flat', type: 'property'},
    {label: 'billboard', type: 'property'},
    ...
    {label: 'lateral-offset-unit', type: 'property'},
    ...
    {label: 'label-collision', type: 'property'},
    {label: 'label-collision-priority', type: 'property'},
    {label: 'label-outline-color', type: 'property'},
    {label: 'label-outline-width', type: 'property'},
    {label: 'label-font-family', type: 'property'},
    {label: 'label-font-weight', type: 'property'},
    {label: 'label-size', type: 'property'},
    {label: 'label-size-scale', type: 'property'},
    {label: 'label-size-units', type: 'property'},
    {label: 'label-size-min-pixels', type: 'property'},
    {label: 'label-size-max-pixels', type: 'property'},
    {label: 'label-angle', type: 'property'},
    {label: 'label-background', type: 'property'},
    {label: 'label-background-color', type: 'property'},
    {label: 'label-border-color', type: 'property'},
    {label: 'label-border-width', type: 'property'},
    {label: 'label-background-padding', type: 'property'},
    {label: 'label-background-border-radius', type: 'property'},
    {label: 'label-text-anchor', type: 'property'},
    {label: 'label-alignment-baseline', type: 'property'},
    {label: 'label-text-expression', type: 'property'},
    {label: 'label-text', type: 'property'},
    {label: 'label-pixel-offset', type: 'property'},
    {label: 'label-line-height', type: 'property'},
    {label: 'label-word-break', type: 'property'},
    {label: 'label-max-width', type: 'property'},
    ...
    {label: 'interaction-effects', type: 'property'},
    {label: 'tint', type: 'property'},
    {label: 'tint-mix', type: 'property'},
    {label: 'edge-width', type: 'property'},
    {label: 'halo', type: 'property'},
    {label: 'radius', type: 'property'},
    {label: 'stripe', type: 'property'},
    ...
    {label: 'miter', type: 'keyword'},
    {label: 'pixels', type: 'keyword'},
    {label: 'meters', type: 'keyword'},
    {label: 'common', type: 'keyword'},
    {label: 'start', type: 'keyword'},
    {label: 'middle', type: 'keyword'},
    {label: 'end', type: 'keyword'},
    {label: 'top', type: 'keyword'},
    {label: 'center', type: 'keyword'},
    {label: 'bottom', type: 'keyword'},
    {label: 'break-word', type: 'keyword'},
    {label: 'break-all', type: 'keyword'},
