...
export type  Matrix4 = CesiumType.Matrix4;
...
export type Material = CesiumType.Material;
export const Material = Cesium.Material;
export type MaterialAppearance = CesiumType.MaterialAppearance;
export const MaterialAppearance = Cesium.MaterialAppearance;
...
export type  Cesium3DTileset = CesiumType.Cesium3DTileset;
export const Cesium3DTileset = Cesium.Cesium3DTileset;
export type  Model = CesiumType.Model;
export const Model = Cesium.Model;
...
export type CustomShader = CesiumType.CustomShader;
export const CustomShader = Cesium.CustomShader;
export type CustomShaderMode = CesiumType.CustomShaderMode;
export const CustomShaderMode = Cesium.CustomShaderMode;
export type CustomShaderTranslucencyMode = CesiumType.CustomShaderTranslucencyMode;
export const CustomShaderTranslucencyMode = Cesium.CustomShaderTranslucencyMode;
export type VaryingType = CesiumType.VaryingType;
export const VaryingType = Cesium.VaryingType;
export type UniformType = CesiumType.UniformType;
export const UniformType = Cesium.UniformType;
export type LightingModel = CesiumType.LightingModel;
export const LightingModel = Cesium.LightingModel;
...
export type VertexFormat = CesiumType.VertexFormat;
export const VertexFormat = Cesium.VertexFormat;
